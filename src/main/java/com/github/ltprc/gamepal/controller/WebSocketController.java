        ...
        for (Object chatMessage : chatMessages) {
            ...
            case 1:
                ...
                for (Entry<String, UserData> userDataEntry : ServerUtil.userDataMap.entrySet()) {
                    ...
                    Queue<ChatMessage> chatMessageQueue = ServerUtil.chatMap.get(userCode);
                    chatMessageQueue.add(newMessage);
                }
                break;
            case 2:
                ChatMessage newMessage = new ChatMessage();
        ...
        for (Object voiceMessage : voiceMessages) {
            ...
            case 1:
                ...
                for (Entry<String, UserData> userDataEntry : ServerUtil.userDataMap.entrySet()) {
                    ...
                    newMessage.setType(type);
                    newMessage.setContent(content);
                    Queue<VoiceMessage> voiceMessageQueue = ServerUtil.voiceMap.get(userCode);
                    voiceMessageQueue.add(newMessage);
                }
                break;
            case 2:
                VoiceMessage newMessage = new VoiceMessage();
